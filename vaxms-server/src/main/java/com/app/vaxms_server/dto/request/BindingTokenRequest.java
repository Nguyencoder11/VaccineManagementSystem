...
public class BindingTokenRequest extends Request{
    ...
    public BindingTokenRequest(String partnerCode, String orderId, String requestId, Language language, String partnerClientId, String callbackToken, String signature) {
        super(partnerCode, orderId, requestId, language);
        this.partnerClientId = partnerClientId;
        this.callbackToken = callbackToken;
        this.signature = signature;
    }
