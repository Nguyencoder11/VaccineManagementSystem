...
import logomini from '../../assets/images/vaxmslogo3.png'
...
function ThanhCong(){
    ...
    useEffect(()=>{
        const checkPayment= async() =>{
            ...
            var res = await postMethodPayload('/api/customer-schedule/customer/finish-payment?id='+customerschedule, payload)
            if (res.status < 300) {
